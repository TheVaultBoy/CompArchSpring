// Image Processing.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CImageProcessingApp

CImageProcessingApp theApp;


// инициализация CImageProcessingApp
